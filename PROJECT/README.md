...
- [ ] **Demo video** in project root: record a short video showing features and a walkthrough of frontend and backend code (required by assignment; add `demo.mp4` or similar to the repo).
